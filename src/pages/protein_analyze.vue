          ...
          <v-card-text class="pa-6">
            <v-form @submit.prevent="submitForm">
              ...
              <v-select
                ...
                :items="databaseFiles"
                label="Выбрать файл из базы данных"
                ...
                dense
                class="mb-4"
                :rules="[v => !!v || 'Выбор файла обязателен']"
              ></v-select>
...
export default {
  data() {
    return {
      uploadMode: 'upload', // Default mode
      loading: false,
      databaseFiles: [], // Array of files from the database
      selectedFile: '',
      snackbar: false,
      snackbarText: '',
      snackbarColor: '',
 ...
 if (Array.isArray(data.data)) {
  this.databaseFiles = data.data; // Убедитесь, что это массив объектов с id и name
    } else {
