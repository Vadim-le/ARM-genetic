<template>
  <v-app>
    ...
    <v-list v-show="showToolsDetails" class="pl-4">
      ...
      <v-list-item 
        @click="selectPage('find_repeats')" 
        :class="{ 'selected-category': selectedCategory === 'find_repeats' }">
...
export default {
  ...
  // Если передан параметр strainName, то устанавливаем его в компоненте NucleotideAnalyze
  if (strainName) {
